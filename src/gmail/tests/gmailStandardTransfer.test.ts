...
const standardTransferTestCases: PaymentDetailsTestCase<StandardTransfer>[] = [
...
describePaymentDetailsTests<StandardTransfer>('Gmail > Standard Transfer > Payment Details Tests', transactionDataTestCases, standardTransferTestCases);

describeTransactionDataTests('Gmail > Standard Transfer > Transaction Data Tests', transactionDataTestCases, standardTransferTestCases);
