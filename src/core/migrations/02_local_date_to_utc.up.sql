-- Convert the time zone of all rows in the 'date' column
-- from Europe/Sofia to UTC, accounting for daylight savings
-- i.e DST is observed from the last Sunday of March, to the last Sunday of October

UPDATE `transactions`
SET `date` = (
    SELECT CONVERT_TZ(`date`,
